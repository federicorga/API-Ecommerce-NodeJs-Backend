...
router.get('/cart/:cid', jwtMiddlewareAuthenticate, privateAccess, authorizationRole(['user']), CartRender); //vista de carrito
...
router.get('/users', jwtMiddlewareAuthenticate, authorizationRole(['admin']), usersView)
